 ...
 * =============================================================================
 */
package com.droideve.apps.nearbystores.unbescape.xml;
...
final class XmlEscapeSymbols {
    ...
    XmlEscapeSymbols(final References references, final byte[] escapeLevels,
        ...
        // Reservation the CODEPOINT -> CERs (escape)structures
        ...
        // Reservation the CERs -> CODEPOINT (unescape)structures
        for (short i = 0; i < structureLen; i++) {
