...
import com.droideve.apps.nearbystores.dtmessenger.InComingDataParserSender;
...
public class DTNotificationManager {
    ...
    public void parse(String incomingData) {
        ...
        if (APP_DEBUG) {
            NSLog.e("incomingData", incomingData);
        }
        ...
        if (AppConfig.APP_DEBUG)
            NSLog.e(FirebaseMessagingServiceIns.TAG, data.toString());
        ...
        if (mParser.getType().equals(Parser.OFFER)) {
            ...
            if (AppConfig.APP_DEBUG && mParser.getBody() != null)
                NSLog.e(FirebaseMessagingServiceIns.TAG, mParser.getBody().toString());
            ...
            boolean notif_global = PreferenceManager.getDefaultSharedPreferences(context)
                    .getBoolean("notif_global", true);
            ...
            if (AppConfig.APP_DEBUG)
                NSLog.e(FirebaseMessagingServiceIns.TAG, mParser.toString());
            ...
            if (APP_DEBUG) {
                NSLog.e("CMarkViewClicked", data.toString());
            }
    ...
    public static class Parser {
        ...
        public static String STORE = Constances.ModulesConfig.STORE_MODULE;
        public static String OFFER = Constances.ModulesConfig.OFFER_MODULE;
        public static String EVENT = Constances.ModulesConfig.EVENT_MODULE;
