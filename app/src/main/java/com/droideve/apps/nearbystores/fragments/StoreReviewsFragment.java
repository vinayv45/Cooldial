...
import com.droideve.apps.nearbystores.adapter.StoreReviewsAdapter;
...
import com.droideve.apps.nearbystores.controllers.ReviewController;
...
public class StoreReviewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            if (APP_DEBUG)
                NSLog.e("_4_store_id", String.valueOf(store_id));
    ...
    public void getComment(final View rootview) {
        ...
        SimpleRequest request = new SimpleRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                if (APP_DEBUG)
                    NSLog.e("listReviewsRequested", "" + params.toString());
