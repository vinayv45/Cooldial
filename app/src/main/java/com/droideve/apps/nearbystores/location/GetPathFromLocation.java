    ...
    protected PolylineOptions doInBackground(String... url) {
        ...
        try {
            ...
            try {
                ...
                NSLog.e(TAG, "Exception : " + e.toString());
                return null;
            } finally {
                inputStream.close();
                connection.disconnect();
            }
            NSLog.e(TAG, "Background Task data : " + data);
            ...
            try {
                ...
                NSLog.e(TAG, "Executing Routes : "/*, routes.toString()*/);
                ...
                for (int i = 0; i < routes.size(); i++) {
                    ...
                    NSLog.e(TAG, "PolylineOptions Decoded");
                }
                ...
                NSLog.e(TAG, "Exception in Executing Routes : " + e.toString());
                return null;
            }

        } catch (Exception e) {
            NSLog.e(TAG, "Background Task Exception : " + e.toString());
            return null;
        }
    }
