...
public class MapStoresListActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void hideStoreFocusLayout() {
        ...
        if (store_focus_layout.isShown())
            com.droideve.apps.nearbystores.animation
    ...
    private void showStoreFocusLayout(final Store store) {
        ...
        ImageView image = store_focus_layout.findViewById(R.id.image);
        ...
        if (store.getListImages() != null && store.getListImages().size() > 0) {
            Glide.with(getBaseContext())
                    .load(store.getListImages().get(0)
                            .getUrlFull())
            ...
            Glide.with(getBaseContext())
                    ...
                    .centerCrop().placeholder(R.drawable.def_logo).into(image);

        }


        store_focus_layout.setVisibility(View.VISIBLE);
        com.droideve.apps.nearbystores.animation.Animation.startCustomZoom(store_focus_layout);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnCameraMoveCanceledListener(new GoogleMap.OnCameraMoveCanceledListener() {
            ...
            public void onCameraMoveCanceled() {
                ...
                if (AppConfig.APP_DEBUG)
                    NSLog.i("onCameraMoveCanceled", String.valueOf(mMap.getCameraPosition().target.latitude));
            }
        });
        ...
        mMap.setOnCameraMoveListener(new GoogleMap.OnCameraMoveListener() {
            ...
            public void onCameraMove() {
                ...
                if (AppConfig.APP_DEBUG)
                    NSLog.i("onCameraMove", String.valueOf(mMap.getCameraPosition().target.latitude));
        ...
        mMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                if (AppConfig.APP_DEBUG)
                    NSLog.i("onCameraIdle", String.valueOf(mMap.getCameraPosition().target.latitude));
            }
        });
...
//
            ...
            protected Map<String, String> getParams() {
                ...
                if (APP_DEBUG) {
                    NSLog.i("mapsStoresActivity", "  params map :" + params.toString());
                }
