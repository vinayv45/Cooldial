...
//
        ...
        SimpleRequest request = new SimpleRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (APP_DEBUG) {
                        NSLog.e("responseUsersString", response);
                    }
                    ...
                    if (page == 1) {
                        ...
                        (new Handler()).postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (APP_DEBUG) {
                                    NSLog.e("count ", list.size() + " page = " + page);
                                }
            ...
            protected Map<String, String> getParams() {
                ...
                if (APP_DEBUG) {
                    NSLog.e("ListUsersFragment", "  params getOffers :" + params.toString());
                }
    ...
    public void itemClicked(int position) {
        ...
        /*if (APP_DEBUG)
            if (mUserSession != null)
                NSLog.e("___clicked", adapter.getItem(position).getUsername() + "==" + mUserSession.getUsername());
*/
    ...
    private void sendMessage(final User user) {
        if (SessionsController.isLogged()) {
            ...
            getActivity().startActivity(new Intent(getContext(), LoginV2Activity.class));
        }
    ...
    public void itemMenuClicked(View view, final int position) {
        ...
        try {
            ...
            //NSLog.w(SliderActivity.class.getName(), "showError forcing menu icons to show", e);
            popupMenu.show();
            return;
        }
