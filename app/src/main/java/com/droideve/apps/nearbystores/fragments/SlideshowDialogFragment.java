...
import com.droideve.apps.nearbystores.classes.SimpleImage;
import com.droideve.apps.nearbystores.views.Blur;
import com.droideve.apps.nearbystores.views.BlurImageView;
...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (AppContext.DEBUG) {
            NSLog.e(TAG, "position: " + selectedPosition);
            NSLog.e(TAG, "images size: " + images.size());
        }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(getContext()).load(image.getSmallUrl()).transform(new Blur(getContext(), 20)).into(mBlurImageView);
