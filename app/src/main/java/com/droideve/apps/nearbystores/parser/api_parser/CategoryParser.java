    ...
    public RealmList<Category> getCategories() {
        ...
        try {
            ...
            for (int i = 0; i < json_array.length(); i++) {
                ...
                if (!json_user.isNull("icon") && !json_user.getString("icon").equals("")) {
                ...
                if (AppConfig.APP_DEBUG)
                    NSLog.i("categoryImages", json_user.getString("image"));
        ...
        try {
            ...
            for (int i = 0; i < json_array.length(); i++) {
                ...
                try {
                    ...
                    if (AppConfig.APP_DEBUG)
                        NSLog.i("categoryMImages", json_user.getString("image"));
